...
<div class="top">
	...
	<div class="content">
			...
			<div class="content-ok">
				<FORM  METHOD="POST" ACTION="/index.php/Home/Yuyue/add">

					<table bordercolor="#00FFFF">
						<tr><td class="tblf">姓名</td><td class="tbrg"><input type="hidden" name="id" >
							<INPUT   TYPE="text" NAME="user" /></td></tr>
						<tr><td><hr></td><td><hr></td></tr>
						<tr><td class="tblf">手机</td><td class="tbrg"><INPUT   TYPE="text" NAME="title" value=""/></td></tr>
						<tr><td><hr></td><td><hr></td></tr>
						<tr><td class="tblf">小区</td><td class="tbrg"><INPUT   TYPE="text" NAME="content" value=""/></td></tr>
						<tr><td><hr></td><td><hr></td></tr>
