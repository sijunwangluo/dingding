...
<div class="top">
	...
	<p style="color:red;text-align:center;">有<?php echo ($count); ?>个新的客户，等待处理！</p>
		  ...
		  <span>预约客户ID:<b><?=$row[id]?></b></span>&nbsp;
		  <button><a href="/index.php/Home/Yuyue/bianji?id=<?php echo ($data["id"]); ?>">备注</a></button>
		  
		  <button><a href="/index.php/Home/Yuyue/makedealwithed?id=<?php echo ($data["id"]); ?>" onclick="javascript:return contacted()">已联系</a></button>
		  <button><a href="/index.php/Home/Yuyue/maketrash?id=<?php echo ($data["id"]); ?>" onclick="javascript:return del()">删除</a></button>
		  </div>
